...
- **Asynchronous scanning** with configurable parallelism for fast network sweeps
...
- **Background operation** with daemon mode
...
--------------+-------------------+-------+------+----------
192.168.1.1   | 00:11:22:33:44:55 | eth0  | 1    | 0.5234
192.168.1.3   | aa:bb:cc:dd:ee:ff | eth0  | 2    | 0.8901
```
...
192.168.1.3   | aa:bb:cc:dd:ee:ff | eth0  | 1    | 0.8901
```
...
The tool uses two scanning approaches based on the `--tasks` parameter:
